...
A custom PHP login form with JSON-based attempt logging was built for this test. Setup details are documented separately:[Login Lab](SIEM-SOAR/login-lab-README.md)
