...
This project documents the creation of a small **PHP login lab application** using #Claude_code to generate realistic web authentication events for security monitoring and detection testing (e.g.[wazuh](wazuh_siem_project/README.md))
